...
urlpatterns = [
    ...
    path('collections/add_spot/', views.AddSpot.as_view(), name='add_spot'),
    path('collections/show_spot/', views.ShowSpot.as_view(), name='show_spot'),
    path('show_spot/<int:id>/', views.ShowDetailSpot.as_view(), name='show_detail_spot'),
    ...
    path('collections/update_item_in_collection/<int:id>/', views.UpdateItemInCollectionView.as_view(), name='update_item_in_collection'),
    path('collections/update_service_in_collection/<int:id>/', views.UpdateServiceInCollectionView.as_view(), name='update_service_in_collection'),
    ]
